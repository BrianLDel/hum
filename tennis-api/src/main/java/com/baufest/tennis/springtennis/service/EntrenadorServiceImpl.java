...
public class EntrenadorServiceImpl implements EntrenadorService{
	...
	public static final String FIELD_WITH_ID = "Entrenador con id = ";
	...
	public EntrenadorDTO save(EntrenadorDTO entrenador) {
		...
		return this.entrenadorMapper
				.toDTO(entrenadorRepository.save(this.entrenadorMapper.fromDTO(entrenador)));
	}
