...
@Mapper(uses = {TorneoMapper.class,EntrenadorMapper.class,CanchaMapper.class,JugadorMapper.class},componentModel = "spring", injectionStrategy = InjectionStrategy.CONSTRUCTOR)
